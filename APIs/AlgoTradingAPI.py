...
try:
    ...
    from APIs.OandaAPI import Market_order, Execution_details
    from APIs.VantageAlphaAPI import est_to_utc
    ...
    def algo_execution(self, units, strategy):
        ...
        if indicator == "SMA":
            ...
            if direction_current > 0 and direction_prior < 0:  # Golden Cross
                execution = Market_order(units, oanda_instrument, "trade")
