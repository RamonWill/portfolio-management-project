...
class RegistrationWindow(tk.Toplevel):
    def __init__(self, authenticator):
        ...
        self.entry_news_api = ttk.Entry(main_frame, width=20, cursor="xterm",
                                  show="*")
        ...
        self.entry_av = ttk.Entry(main_frame, width=20, cursor="xterm",
                                  show="*")
        ...
        self.entry_oanda_acc = ttk.Entry(main_frame, width=20, cursor="xterm",
                                  show="*")
        ...
        self.entry_oanda_api = ttk.Entry(main_frame, width=20, cursor="xterm",
                                  show="*")
